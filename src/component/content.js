  ...
  return (
    ...
    >
      ...
      <div className="row p-2">
        ...
        <div className="col-6 mx-1 d-flex justify-content-around">
        <botton className="btn" onClick={() => {props.deleteNote(props.note._id)}}>
          <img src={del} style={{ width: "20px" }} alt="delete" />
        </botton>
        <Model id = {props.note._id} tag = {props.note.tag} title = {props.note.title} description = {props.note.description} color={props.note.color}/>
        <Edit id = {props.note._id} tag = {props.note.tag} title = {props.note.title} description = {props.note.description} color={props.note.color}/>
        </div>
        </div>
      </div>
    </div>
